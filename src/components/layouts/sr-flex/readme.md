...
| `gap`        | `gap`        | The `gap` property adjusts spacing between children components inside flex                           | `"spacer-0" \| "spacer-1" \| "spacer-2" \| "spacer-3" \| "spacer-4" \| "spacer-5" \| "spacer-6" \| "spacer-7" \| "spacer-8" \| "spacer-blockquote" \| "spacer-caption" \| "spacer-endnote" \| "spacer-h1" \| "spacer-h2" \| "spacer-h3" \| "spacer-h4" \| "spacer-h5" \| "spacer-h6" \| "spacer-text"` | `undefined`    |
